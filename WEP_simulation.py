...
with col1:
    st.write('南面のWEPH')
    st.markdown(f"{df_S[f'{select_winodow_s}'][0]:.2f}[kW/年]")
    st.write('南面のWEPC')
    st.markdown(f"{df_S[f'{select_winodow_s}'][1]:.2f}[kW/㎡年]")


with col2:
    st.write('北面のWEPH')
    st.markdown(f"{df_N[f'{select_winodow_n}'][0]:.2f}[kW/㎡年]")
    st.write('北面のWEPC')
    st.markdown(f"{df_N[f'{select_winodow_n}'][1]:.2f}[kW/㎡年]")
    
with col3:
    st.write('東面のWEPH')
    st.markdown(f"{df_E[f'{select_winodow_e}'][0]:.2f}[kW/㎡年]")
    st.write('東面のWEPC')
    st.markdown(f"{df_E[f'{select_winodow_e}'][0]:.2f}[kW/㎡年]")
    
with col4:
    st.write('西面のWEPH')
    st.markdown(f"{df_W[f'{select_winodow_w}'][0]:.2f}[kW/㎡年]")
    st.write('西面のWEPC')
    st.markdown(f"{df_W[f'{select_winodow_w}'][1]:.2f}[kW/㎡年]")
