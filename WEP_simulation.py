...
df_S=pd.read_csv(Rf'WEP_Result47_4dir/{select_location}/direct_select/S/WEP_Result_{select_location}_S.csv', header=0,sep=',',engine='python',encoding='cp932')
df_E=pd.read_csv(Rf'WEP_Result47_4dir/{select_location}/direct_select/E/WEP_Result_{select_location}_E.csv', header=0,sep=',',engine='python',encoding='cp932')
df_N=pd.read_csv(Rf'WEP_Result47_4dir/{select_location}/direct_select/N/WEP_Result_{select_location}_N.csv', header=0,sep=',',engine='python',encoding='cp932')
df_W=pd.read_csv(Rf'WEP_Result47_4dir/{select_location}/direct_select/W/WEP_Result_{select_location}_W.csv', header=0,sep=',',engine='python',encoding='cp932')
st.dataframe(df_S)
st.dataframe(df_E)
st.dataframe(df_N)
st.dataframe(df_W)
