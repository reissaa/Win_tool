...
area_data=pd.read_csv(Rf'site_data/省エネ区分・日射区分(47site.ver).csv',index_col=None, header=0,sep=',',engine='python',encoding='cp932')
...
with col1:
    ...
    folium_static(map,width=650, height=500)
with col2:
   st.header("暖冷房期間")
   st.image(img1)
